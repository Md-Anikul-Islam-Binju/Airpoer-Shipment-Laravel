   ...
   <div class="container">
      <div class="row justify-content-center d-flex">
         <div class="col-lg-9 post-list">
            ...
            <form action="{{ route('update.trip', ['id' => $trip->id]) }}" method="POST">  
                @csrf
                {{-- @method('PUT')  --}}
